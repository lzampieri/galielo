...
if(array_key_exists("nome",$_POST)) {
	if(strlen($_POST["nome"]) > 2)
		query("INSERT INTO tornei ( nome , stato , iscr ) VALUES ( '".$_POST["nome"]."' , 1 , 1 )");
}
...
<form class="w3-card-4 width60" method="post">
    <h2 class="w3-text-blue">Crea nuovo torneo</h2>
    <input class="w3-input w3-border" name="nome" type="text" placeholder="Nome del torneo">
    <button class="w3-button w3-block w3-section w3-blue w3-ripple w3-padding" >Crea</button>
</form>
</div>
<?php
require("../tornei/workers/tornlist.php");
?><br/><br />
</div>
</body>
</html>
